...
Having tried multiple ways to make an easy backup of the USB I have, (ChatGPT) has created a script that you can run daily, which creates a file for the USB. It names the file in date order and deletes folders over 7 days.Folder is saved as ZIP
